<script lang="ts">
  ...
  async function handleSave(data: CreateCaptureInput) { await addCapture({ ...data, type: 'link' }); }
...
<div class="page fade-in">
  <div class="page-header">
    ...
    <button class="btn-new" onclick={() => (showModal = true)}>+ {t('capture.addLink')}</button>
  </div>
...
<CaptureModal bind:open={showModal} defaultTab="link" onSave={handleSave} />
